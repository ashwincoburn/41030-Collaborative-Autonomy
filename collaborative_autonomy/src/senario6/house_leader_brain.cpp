...
int main(int argc, char** argv){
  ...
  //Goal 0, Bottom Right
  pointToAdd.target_pose.pose.position.x = -4.24; 
  pointToAdd.target_pose.pose.position.y = -3.56;
  ...
  //Goal 1, Bottom
  pointToAdd.target_pose.pose.position.x = -8.428; 
  pointToAdd.target_pose.pose.position.y = -2.697; 
  pointToAdd.target_pose.pose.position.z = 0.0;
  myQuaternion.setRPY(0,0,180*(180/M_PI));
  pointToAdd.target_pose.pose.orientation.x = myQuaternion.getX();
  pointToAdd.target_pose.pose.orientation.y = myQuaternion.getY();
  ...
  pointToAdd.target_pose.pose.orientation.w = myQuaternion.getW();
  goals.push_back(pointToAdd);
  goalPose.push_back(180);
  //Goal 2
  pointToAdd.target_pose.pose.position.x = -7.318; 
  pointToAdd.target_pose.pose.position.y = -0.317; 
  pointToAdd.target_pose.pose.position.z = 0.0;
  ...
  //Goal 3
  pointToAdd.target_pose.pose.position.x = 0.948; 
  pointToAdd.target_pose.pose.position.y = 2.512; 
  pointToAdd.target_pose.pose.position.z = 0.0;
  myQuaternion.setRPY(0,0,0*(180/M_PI));
  pointToAdd.target_pose.pose.orientation.x = myQuaternion.getX();
  pointToAdd.target_pose.pose.orientation.y = myQuaternion.getY();
  ...
  goalPose.push_back(0);
  //Goal 4
  pointToAdd.target_pose.pose.position.x = 8.223; 
  pointToAdd.target_pose.pose.position.y = 0.79; 
  pointToAdd.target_pose.pose.position.z = 0.0;
  myQuaternion.setRPY(0,0,270*(180/M_PI));
  pointToAdd.target_pose.pose.orientation.x = myQuaternion.getX();
  pointToAdd.target_pose.pose.orientation.y = myQuaternion.getY();
  pointToAdd.target_pose.pose.orientation.z = myQuaternion.getZ();
  pointToAdd.target_pose.pose.orientation.w = myQuaternion.getW();
  goals.push_back(pointToAdd);
  goalPose.push_back(270);
  //Goal 5
  pointToAdd.target_pose.pose.position.x = 6.116; 
  pointToAdd.target_pose.pose.position.y = -3.878; 
  pointToAdd.target_pose.pose.position.z = 0.0;
  myQuaternion.setRPY(0,0,180*(180/M_PI));
  pointToAdd.target_pose.pose.orientation.x = myQuaternion.getX();
  pointToAdd.target_pose.pose.orientation.y = myQuaternion.getY();
